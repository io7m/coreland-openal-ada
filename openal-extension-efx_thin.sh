...
./openal-mkapi.lua         \
  ...
  openal_types.dat         \
  "dynamic" >> openal-extension-efx_thin.ads.tmp || exit 1

./block-comment 'Record type for API pointers' >> openal-extension-efx_thin.ads.tmp || exit 1
./openal-mkapi.lua         \
  "al"                     \
  openal_efx_1_1_types.dat \
  openal_efx_1_1_names.dat \
  openal_types.dat         \
  "api_record" >> openal-extension-efx_thin.ads.tmp || exit 1
